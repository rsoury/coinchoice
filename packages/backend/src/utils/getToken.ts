...
export const getToken = (signer: Wallet, chainId: number, id: string) => {
    return new ethers.Contract(TOKEN_DICT[id][chainId], new ethers.utils.Interface(ERC20.abi), signer) as ERC20MockWithPermit
}